...
public class CompareCalibratorsInfoPanel extends JPanel implements UI_Container {
    ...
    @Override
    public void build() {
        this.add(this.labels[0], new ComparePersonsInfoPanel.Cell(0, 0));
        this.add(this.labels[1], new ComparePersonsInfoPanel.Cell(1, 0));
        this.add(this.labels[2], new ComparePersonsInfoPanel.Cell(2, 0));

        this.add(this.labels[3], new ComparePersonsInfoPanel.Cell(0, 1));
        this.add(this.oldInfo[0], new ComparePersonsInfoPanel.Cell(1, 1));
        this.add(this.newInfo[0], new ComparePersonsInfoPanel.Cell(2, 1));

        this.add(this.labels[4], new ComparePersonsInfoPanel.Cell(0, 2));
        this.add(this.oldInfo[1], new ComparePersonsInfoPanel.Cell(1, 2));
        this.add(this.newInfo[1], new ComparePersonsInfoPanel.Cell(2, 2));

        this.add(this.labels[5], new ComparePersonsInfoPanel.Cell(0, 3));
        this.add(this.oldInfo[2], new ComparePersonsInfoPanel.Cell(1, 3));
        this.add(this.newInfo[2], new ComparePersonsInfoPanel.Cell(2, 3));

        this.add(this.labels[6], new ComparePersonsInfoPanel.Cell(0, 4));
        this.add(this.oldInfo[3], new ComparePersonsInfoPanel.Cell(1, 4));
        this.add(this.newInfo[3], new ComparePersonsInfoPanel.Cell(2, 4));
    }
