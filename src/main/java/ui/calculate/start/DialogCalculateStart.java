...
public class DialogCalculateStart extends JDialog implements Window {
    ...
    public DialogCalculateStart(MainScreen mainScreen, Channel channel, HashMap<Integer, Object> values){
    ...
    public DialogCalculateStart(MainScreen mainScreen, Channel channel, HashMap<Integer, Object> values, SystemData os){
        super(mainScreen, title(channel), true);
        this.mainScreen = mainScreen;
        this.channel = channel;
        this.values = values;
        ...
        public void itemStateChanged(ItemEvent e) {
            if (e.getStateChange() == ItemEvent.SELECTED && calibrator.getSelectedItem() != null){
                if (calibrator.getSelectedItem().toString().equals(ADD_NEW)){
                    EventQueue.invokeLater(() -> new CalibratorInfoDialog(DialogCalculateStart.this, channel).setVisible(true));
                }
            }
        }
    };
    ...
    private class MainPanel extends JPanel {
        ...
        protected MainPanel(boolean withAlarmPanel){
            ...
            if (withAlarmPanel){
                ...
                DialogCalculateStart.this.setSize(820,350);
            }else {
                DialogCalculateStart.this.setSize(820,300);
            }
            DialogCalculateStart.this.setLocation(POINT_CENTER(mainScreen, DialogCalculateStart.this));
        }
