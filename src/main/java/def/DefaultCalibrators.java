...
public class DefaultCalibrators {
    public static ArrayList<Calibrator> get() {
        ...
        fluke725._setCertificateType("Сертифікат калібрування");
        fluke725._setCertificateName("№06/2647К");
        fluke725._setCertificateDate("16.11.2020");
        fluke725._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        fluke724._setCertificateType("Сертифікат калібрування");
        fluke724._setCertificateName("№06/1777К");
        fluke724._setCertificateDate("22.10.2019");
        fluke724._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        prova123_minus._setCertificateType("Сертифікат калібрування");
        prova123_minus._setCertificateName("№06/2315К");
        prova123_minus._setCertificateDate("21.07.2020");
        prova123_minus._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        prova123._setCertificateType("Сертифікат калібрування");
        prova123._setCertificateName("№06/2315К");
        prova123._setCertificateDate("21.07.2020");
        prova123._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        fluke718_30g._setCertificateType("Сертифікат калібрування");
        fluke718_30g._setCertificateName("№05/3570К");
        fluke718_30g._setCertificateDate("02.09.2020");
        fluke718_30g._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        fluke750pd2._setCertificateType("Сертифікат калібрування");
        fluke750pd2._setCertificateName("№05/3570К");
        fluke750pd2._setCertificateDate("02.09.2020");
        fluke750pd2._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        fluke750pd2_smallPressure._setCertificateType("Сертифікат калібрування");
        fluke750pd2_smallPressure._setCertificateName("№05/3570К");
        fluke750pd2_smallPressure._setCertificateDate("02.09.2020");
        fluke750pd2_smallPressure._setCertificateCompany("ДП\"ХарківСтандартМетрологія\"");
        ...
        YAKOGAWA_AM012._setCertificateType("Сертифікат калібрування");
        YAKOGAWA_AM012._setCertificateName("№UA/24/200717/265");
        YAKOGAWA_AM012._setCertificateDate("17.07.2020");
        YAKOGAWA_AM012._setCertificateCompany("ДП\"Укрметртестстандарт\"");
        ...
        ROSEMOUNT_8714DQ4._setCertificateType("Сертифікат калібрування");
        ROSEMOUNT_8714DQ4._setCertificateName("відповідно до стандарту ISO 10474.3.1B");
        ROSEMOUNT_8714DQ4._setCertificateDate("22.11.2019");
        ROSEMOUNT_8714DQ4._setCertificateCompany("\"EMERSON\"");
