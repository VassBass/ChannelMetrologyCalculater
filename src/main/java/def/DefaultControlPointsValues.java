...
public class DefaultControlPointsValues {
    ...
    public static ArrayList<ControlPointsValues> get(){
        ...
        List<Double> values_tcm50m_0_100 = Arrays.asList(0D, 5.14, 50D, 94.86, 100D);
        List<Double> values_tcm50m_m50_180 = Arrays.asList(-50.13, -39.59, 64.95, 168.22, 179.9);
        List<Double> values_tcm50m_0_125 = Arrays.asList(0D, 6.08, 62.15, 118.69, 124.77);
        List<Double> values_tcm50m_0_150 = Arrays.asList(0D, 7.48, 74.77, 142.52, 150D);
        List<Double> values_tcm50m_m20_125 = Arrays.asList(-20D, -12.6, 52.34, 118.69, 124.77);
        List<Double> values_tcm50m_m20_150 = Arrays.asList(-20D, -11.67, 64.95, 141.59, 150D);
        ...
        List<Double> values_Pt100_0_100 = Arrays.asList(0D, 5.12, 50D, 94.98, 100D);
        List<Double> values_Pt100_0_125 = Arrays.asList(0D, 6.15, 62.5, 118.76, 125.13);
        List<Double> values_Pt100_0_150 = Arrays.asList(0D, 7.43, 75.03, 142.4, 149.93);
        List<Double> values_Pt100_m20_125 = Arrays.asList(-20.15, -13.02, 52.61, 117.96, 125.13);
        List<Double> values_Pt100_m20_150 = Arrays.asList(-20.15, -11.67, 64.84, 141.38, 149.93);
