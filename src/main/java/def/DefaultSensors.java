...
public class DefaultSensors {
    public static ArrayList<Sensor> get() {
        ...
        tcm_50m.setValue(MeasurementConstants.DEGREE_CELSIUS);
        tcm_50m.setMeasurement(MeasurementConstants.TEMPERATURE);
        ...
        tcp_100.setValue(MeasurementConstants.DEGREE_CELSIUS);
        tcp_100.setMeasurement(MeasurementConstants.TEMPERATURE);
        tcp_100.setErrorFormula("(0.005 * R) + 0.3");
        sensors.add(tcp_100);

        Sensor txa_2388_typeK = new Sensor();
        txa_2388_typeK.setType("Термопара TXA-2388 (тип К)");
        txa_2388_typeK.setName("Термопара TXA-2388 (тип К) < 333.5" + MeasurementConstants.DEGREE_CELSIUS);
        txa_2388_typeK.setRange(-50D,1250D);
        txa_2388_typeK.setValue(MeasurementConstants.DEGREE_CELSIUS);
        txa_2388_typeK.setMeasurement(MeasurementConstants.TEMPERATURE);
        ...
        txa_2388_typeK_big.setName("Термопара TXA-2388 (тип К) > 333.5" + MeasurementConstants.DEGREE_CELSIUS);
        txa_2388_typeK_big.setRange(-50D,1250D);
        txa_2388_typeK_big.setValue(MeasurementConstants.DEGREE_CELSIUS);
        txa_2388_typeK_big.setMeasurement(MeasurementConstants.TEMPERATURE);
        ...
        txa_0395_typeK.setName("Термопара TXA-0395 (тип К) < 333.5" + MeasurementConstants.DEGREE_CELSIUS);
        txa_0395_typeK.setRange(-50D,1250D);
        txa_0395_typeK.setValue(MeasurementConstants.DEGREE_CELSIUS);
        txa_0395_typeK.setMeasurement(MeasurementConstants.TEMPERATURE);
        ...
        txa_0395_typeK_big.setName("Термопара TXA-0395 (тип К) > 333.5" + MeasurementConstants.DEGREE_CELSIUS);
        txa_0395_typeK_big.setRange(-50D,1250D);
        txa_0395_typeK_big.setValue(MeasurementConstants.DEGREE_CELSIUS);
        txa_0395_typeK_big.setMeasurement(MeasurementConstants.TEMPERATURE);
        ...
        tp0198_2.setName("ТП 0198/2 < 333.5" + MeasurementConstants.DEGREE_CELSIUS);
        tp0198_2.setRange(-40D,1100D);
        tp0198_2.setValue(MeasurementConstants.DEGREE_CELSIUS);
        tp0198_2.setMeasurement(MeasurementConstants.TEMPERATURE);
        tp0198_2.setErrorFormula("2.5");
        sensors.add(tp0198_2);

        Sensor tp0198_2_big = new Sensor();
        tp0198_2_big.setType("ТП 0198/2");
        tp0198_2_big.setName("ТП 0198/2 > 333.5" + MeasurementConstants.DEGREE_CELSIUS);
        tp0198_2_big.setRange(-40D,1100D);
        tp0198_2_big.setValue(MeasurementConstants.DEGREE_CELSIUS);
        tp0198_2_big.setMeasurement(MeasurementConstants.TEMPERATURE);
        ...
        deltabarS.setMeasurement(MeasurementConstants.PRESSURE);
        ...
        fisherRosemount3051s.setMeasurement(MeasurementConstants.PRESSURE);
        ...
        yokogawa.setMeasurement(MeasurementConstants.PRESSURE);
        ...
        jumoDTransP02.setMeasurement(MeasurementConstants.PRESSURE);
        ...
        yokogawa_axf050g.setMeasurement(MeasurementConstants.CONSUMPTION);
        ...
        rosemount_8750.setMeasurement(MeasurementConstants.CONSUMPTION);
