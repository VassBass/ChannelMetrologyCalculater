...
public class PropertiesCalibratorListConfigHolder implements CalibratorListConfigHolder {
    private static final Logger logger = LoggerFactory.getLogger(PropertiesCalibratorListConfigHolder.class);

    private static final String PROPERTIES_FILE_PATH = "properties/calibrator.properties";
    private static final String KEY_DIALOG_WIDTH = "calibrator.list.dialog.width";
    private static final String KEY_DIALOG_HEIGHT = "calibrator.list.dialog.height";

    private int dialogWidth = 100;
    private int dialogHeight = 100;

    public PropertiesCalibratorListConfigHolder() {
