...
public class Files {
    ...
    public static final File FILE_FORM_CONSUMPTION_BAD = new File(FORMS_DIR, Strings.FILE_NAME_FORM_CONSUMPTION_BAD);
    public static final File FILE_FORM_CONSUMPTION_GOOD = new File(FORMS_DIR, Strings.FILE_NAME_FORM_CONSUMPTION_GOOD);
    public static final File FILE_FORM_CONSUMPTION_ROSEMOUNT_BAD = new File(FORMS_DIR, Strings.FILE_NAME_FORM_CONSUMPTION_ROSEMOUNT_BAD);
    public static final File FILE_FORM_CONSUMPTION_ROSEMOUNT_GOOD = new File(FORMS_DIR, Strings.FILE_NAME_FORM_CONSUMPTION_ROSEMOUNT_GOOD);
