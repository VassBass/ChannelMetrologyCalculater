...
public class ImportInstallations extends SwingWorker<Integer, Void> {
    ...
    public ImportInstallations(File exportDataFile){
        super();
    ...
    protected Integer doInBackground() throws Exception {
        ...
        if (list == null){
            ...
            Application.context.installationService.rewriteInCurrentThread(list);
            return 0;
        }
    }
    ...
    private ArrayList<String> newInstallationsList() throws Exception {
        ...
        ArrayList<String>oldList = Application.context.installationService.getAll();
