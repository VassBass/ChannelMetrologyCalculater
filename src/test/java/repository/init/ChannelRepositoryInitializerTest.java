...
public class ChannelRepositoryInitializerTest {
    private static final Logger logger = LoggerFactory.getLogger(ChannelRepositoryInitializerTest.class);
    ...
    public void setUp() {
        ...
        initializer = new ChannelRepositoryInitializer(configHolder, connector);
    }
