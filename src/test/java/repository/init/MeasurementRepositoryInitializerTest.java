...
public class MeasurementRepositoryInitializerTest {
    private static final Logger logger = LoggerFactory.getLogger(MeasurementRepositoryInitializerTest.class);
    ...
    public void setUp() {
        ...
        initializer = new MeasurementRepositoryInitializer(configHolder, connector);
    }
