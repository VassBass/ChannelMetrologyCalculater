...
public class ConsumptionCalculationWorkerTest {

    private RepositoryMockFactory repositoryMockFactory;
    private ConsumptionCalculationWorker worker;

    @Before
    public void init() {
        repositoryMockFactory = new RepositoryMockFactory(new RepositoryConfigHolderMock());
        worker = new ConsumptionCalculationWorker(repositoryMockFactory);
    }
    ...
    public void testCalculateStandardIndeterminacyB() {
        ...
        assertEquals(0.3, worker.calculateStandardIndeterminacyB(sensorError, calibratorError), 0.000000001);
    }
    ...
    public void testCalculateTotalStandardIndeterminacy() {
        ...
        assertEquals(0.379286119, worker.calculateTotalStandardIndeterminacy(a, b), 0.000000001);
    }

    @Test
    public void testCalculateExtendedIndeterminacy() {
        double total = 0.379286119;

        assertEquals(0.758572238, worker.calculateExtendedIndeterminacy(total, 2.0), 0.00000001);
    }
